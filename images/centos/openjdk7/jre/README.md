...
This image is based on CentOS and provides OpenJDK 7 (JRE)
...
* [Jolokia](http://www.jolokia.org) : version **2.0.0-M2** and port **8778**
* [jmx_exporter](https://github.com/prometheus/jmx_exporter): version **0.6** and port **9779**
